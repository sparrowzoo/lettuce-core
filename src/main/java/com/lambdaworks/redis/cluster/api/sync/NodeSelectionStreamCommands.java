...
public interface NodeSelectionStreamCommands<K, V> {
     ...
     */
    Executions<String> xadd(K key, Map<K, V> body);
     ...
     * @return simple-reply the message Id.
     */
    Executions<String> xadd(K key, XAddArgs args, Map<K, V> body);
     ...
     * @return simple-reply the message Id.
     */
    Executions<String> xadd(K key, Object... keysAndValues);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    Executions<List<StreamMessage<K, V>>> xread(Stream<K>... streams);
     ...
     * @return List&lt;StreamMessage&gt; array-reply list with members of the resulting stream.
     */
    Executions<List<StreamMessage<K, V>>> xread(XReadArgs args, Stream<K>... streams);
}
